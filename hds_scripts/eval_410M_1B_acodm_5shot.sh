...
for SEED in ${SEEDS[@]}; do
    ...
    # evaluate
    bash scripts/evaluate5shot.sh outputs/${RUN_NAME}/global_step41667/configs/${RUN_NAME}.yml hds_config/models/eval_1B_1gpu.yml 2>&1 | tee outputs/${RUN_NAME}_eval.log &
