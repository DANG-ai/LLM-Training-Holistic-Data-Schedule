...
CONFIGS="hds_config/data/pile.yml hds_config/init.yml hds_config/models/1B.yml hds_config/eval_tasks.yml hds_config/sac_410m_1B.yml hds_config/train_data_weights/original_pile.yml"
